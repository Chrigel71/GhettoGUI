# GhettoGUI_V8.4.0.ps1
#
# --- VERSION V8.4.0 (Final Stable Release by Gemini & Chrigel#71)
...
$form.Text = "GhettoGUI ESXi & GhettoVCB Manager V8.4.0 / 16.01.2026"
...
$checkboxDisablePunch.Text = "Hole Punching deakt." # Oder: "Kein Punching (Schneller)"
...
$toolTip.SetToolTip($checkboxDisablePunch, "Wenn aktiviert, wird bei 'thin' Disks keine nachträgliche Speicherplatzfreigabe durchgeführt.`nDas Backup ist schneller, verbraucht aber evtl. mehr Platz auf dem Ziel.")
# ----------------------------------------------------
...
log_raw "Job-Konfiguration:"; log_raw "  - Typ: Manueller Multi-VM Hot-Klon V8.4.0"; log_raw "  - Ziel-Datastore: ${TARGET_DATASTORE}"; log_raw "  - Namens-Vorlage: ${NAME_TEMPLATE}"; log_raw "Speicherplatz (Vorher):"; log_raw "  - Ziel (${TARGET_DATASTORE}): $(df -h "${TARGET_DATASTORE}" 2>/dev/null | grep /vmfs/)"; log_raw "--- START DES DETAILLOGS ---";
...
log_raw "Startzeit: $(date '+%Y-%m-%d %H:%M:%S')"
log_raw "Job-Konfiguration:"; log_raw "  - Typ: Lokaler Hot-Klon V8.4.0"; log_raw "  - Quelle: ${SOURCE_VM_NAME}"; log_raw "--- START DES DETAILLOGS ---"
...
log "====== GEPLANTER VM KLON-PROZESS GESTARTET (ID: ${UNIQUE_ID}) ======"; log_raw "Startzeit: $(date '+%Y-%m-%d %H:%M:%S')"; log_raw "Job-Konfiguration:"; log_raw "  - Typ: Geplanter Lokaler Hot-Klon V8.4.0"; log_raw "  - Quelle: ${SOURCE_VM_NAME}"; log_raw "--- START DES DETAILLOGS ---"
...
log_raw "Startzeit: $(date '+%Y-%m-%d %H:%M:%S')"
log_raw "Job-Konfiguration:"; log_raw "  - Typ: Geplanter Multi-VM Hot-Klon V8.4.0"; log_raw "  - Ziel-Datastore: ${TARGET_DATASTORE}"; log_raw "  - Namens-Vorlage: ${NAME_TEMPLATE}"; log_raw "Speicherplatz (Vorher):"; log_raw "  - Ziel (${TARGET_DATASTORE}): $(df -h "${TARGET_DATASTORE}" 2>/dev/null | grep /vmfs/)"; log_raw "--- START DES DETAILLOGS ---";
...
log_raw "Startzeit: $(date '+%Y-%m-%d %H:%M:%S')"
log_raw "Job-Konfiguration:"
log_raw "  - Typ: GhettoVCB Wiederherstellung V8.4.0"
...
log_raw "Job-Konfiguration:"
log_raw "  - Typ: Geplante Replikation (H2H V8.4.0)"
...
log_raw "Job-Konfiguration:"
log_raw "  - Typ: Manuelle Replikation (H2H) V8.4.0"
log_raw "  - Methode: ${REPLICATION_METHOD}"
