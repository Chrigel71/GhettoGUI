# GhettoGUI_V8.7.5.ps1
#
# --- VERSION V8.7.5 (Final Stable Release by Gemini & Chrigel#71)
...
# - NEU: Proxmox 9.0
# - ghettoVCB_patch_V9.5.sh & sendmail_V9.5.py 07.02.2026
...
$form.Text = "GhettoGUI ESXi & GhettoVCB Manager V8.7.5 / 07.02.2026"
        ...
        if ($confirmInstall -eq [System.Windows.Forms.DialogResult]::Yes) {
            try {
                ...
                if (-not (Get-PackageProvider -Name NuGet -ErrorAction SilentlyContinue)) {
                    ...
                    Install-PackageProvider -Name NuGet -MinimumVersion 2.8.7.501 -Force | Out-Null
...
# VERSION: V8.7.5 (Fix: Log-Filename for Live-View & Stable Logic)
# =======================================================================
...
#!/bin/sh
# GhettoGUI Multi-VM Clone Helper V8.7.6 (Final Log & Email Fix)
...
log_raw "  - Typ: Manueller Multi-VM Hot-Klon V8.7.5"
...
# =======================================================================
# DATEI: CloneScript_Templates_V8.5.0.ps1
# VERSION: V8.7.5 (Final Parity - Based on V54.24 Replication Logic)
# =======================================================================
...
$cloneScriptTemplate = @'
#!/bin/sh
# GhettoGUI Single-VM Clone Helper V8.7.5 (Manual - Stable Email & SCSI-ID)
...
log_raw "Startzeit: $(date '+%Y-%m-%d %H:%M:%S')"
log_raw "Job-Konfiguration:"
log_raw "  - Typ: Manuell Single-VM Hot-Klon V8.7.5"
...
for SOURCE_VM_NAME in ${VM_LIST}; do
    ...
    log "#########8.7.5########### Starte Klon für VM: ${SOURCE_VM_NAME} ####################"
    log "initiate backup for ${SOURCE_VM_NAME}"
...
log_raw "Startzeit: $(date '+%Y-%m-%d %H:%M:%S')"
log_raw "Job-Konfiguration:"; log_raw "  - Typ: Geplante GhettoVCB Wiederherstellung V8.7.5"; log_raw "  - Quelle: ${SOURCE_PATH}"; log_raw "  - Ziel-Datastore: ${TARGET_DATASTORE}"; log_raw "  - Neuer VM-Name: ${NEW_VM_NAME}";
log_raw "--- START DES DETAILLOGS ---"
...
#!/bin/sh
# GhettoGUI Scheduled Multi-VM Clone Helper V8.7.5 (Fix: SCSI-ID Based Naming)
PATH=/bin:/sbin:/usr/bin:/usr/sbin:/usr/lib/vmware/bin
export PATH
...
log_raw "Startzeit: $(date '+%Y-%m-%d %H:%M:%S')"
log_raw "Job-Konfiguration:"
log_raw "  - Typ: Manueller Restore V8.7.5"
...
log_raw "Job-Konfiguration:"
log_raw "  - Typ: Geplante Replikation (H2H V8.7.5)"
...
log_raw "Job-Konfiguration:"
log_raw "  - Typ: Manuelle Replikation (H2H) V8.7.5"
log_raw "  - Methode: ${REPLICATION_METHOD}"
