# GhettoGUI_V8.3.0.0.ps1
#
# --- VERSION V8.3.0.0 (Final Stable Release by Gemini & Chrigel#71)
...
$form.Text = "GhettoGUI ESXi & GhettoVCB Manager V8.3.0.0 / 06.01.2026"
...
#!/bin/sh
# GhettoGUI Multi-VM Replication Helper V54.9 (Option-Split Fix)
# - CRITICAL FIX ESXi 6: Removes '-T' flag from SCP commands (caused "unknown option -- T").
# - LOGIC: Splits SSH_OPTIONS into SSH_OPTS (with -T) and SCP_OPTS (without -T).
# - RETAINS: Late Copy, 2-Step Rename, Absolute Paths.
...
for SOURCE_VM_NAME in ${CLEAN_VM_LIST}; do
    log "#################### Starte Verarbeitung für VM: ${SOURCE_VM_NAME} ########V54.9############"
