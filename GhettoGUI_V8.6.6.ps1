# GhettoGUI_V8.6.6.ps1
#
# --- VERSION V8.6.6 (Final Stable Release by Gemini & Chrigel#71)
...
$form.Text = "GhettoGUI ESXi & GhettoVCB Manager V8.6.6 / 21.01.2026"
        ...
        if ($confirmInstall -eq [System.Windows.Forms.DialogResult]::Yes) {
            try {
                ...
                if (-not (Get-PackageProvider -Name NuGet -ErrorAction SilentlyContinue)) {
                    ...
                    Install-PackageProvider -Name NuGet -MinimumVersion 2.8.6.601 -Force | Out-Null
...
$buttonIntegrityCheck.Add_Click({
    ...
    # --- BUTTONS ---
    $btnLockCheck = New-Object System.Windows.Forms.Button; $btnLockCheck.Text = "KRITISCHE FEHLER PRÜFEN (Lock & Snaps)"; $btnLockCheck.Location = New-Object System.Drawing.Point(20, 50); $btnLockCheck.Size = New-Object System.Drawing.Size(440, 35); $btnLockCheck.ForeColor = [System.Drawing.Color]::DarkRed; $btnLockCheck.Font = New-Object System.Drawing.Font("Segoe UI", 9, [System.Drawing.FontStyle]::Bold)
    
    $btnVaaiCheck = New-Object System.Windows.Forms.Button; $btnVaaiCheck.Text = "VAAI-STATUS & DIENST-CHECK (NAS-Beschleunigung)"; $btnVaaiCheck.Location = New-Object System.Drawing.Point(20, 95); $btnVaaiCheck.Size = New-Object System.Drawing.Size(440, 35); $btnVaaiCheck.ForeColor = [System.Drawing.Color]::DarkBlue

    $btnStorageOpt = New-Object System.Windows.Forms.Button; $btnStorageOpt.Text = "STORAGE-OPTIMIERUNG (iSCSI & Disk-Retries)"; $btnStorageOpt.Location = New-Object System.Drawing.Point(20, 140); $btnStorageOpt.Size = New-Object System.Drawing.Size(440, 35); $btnStorageOpt.ForeColor = [System.Drawing.Color]::DarkGreen

    # NEU: HP-Controller Check
    $btnHpCheck = New-Object System.Windows.Forms.Button; $btnHpCheck.Text = "HP SMART-ARRAY CHECK (Controller & SSD Status)"; $btnHpCheck.Location = New-Object System.Drawing.Point(20, 185); $btnHpCheck.Size = New-Object System.Drawing.Size(440, 35); $btnHpCheck.ForeColor = [System.Drawing.Color]::SaddleBrown

    $diagOutput = New-Object System.Windows.Forms.RichTextBox; $diagOutput.Location = New-Object System.Drawing.Point(20, 235); $diagOutput.Size = New-Object System.Drawing.Size(440, 230); $diagOutput.BackColor = [System.Drawing.Color]::Black; $diagOutput.ForeColor = [System.Drawing.Color]::White; $diagOutput.ReadOnly = $true; $diagOutput.Font = New-Object System.Drawing.Font("Consolas", 9)
    ...
    # --- LOGIK 3: Storage Optimierung (Bestehend) ---
    $btnStorageOpt.Add_Click({
        $diagOutput.Clear()
        if ([System.Windows.Forms.MessageBox]::Show("ESXi 8 iSCSI & Disk-Retries optimieren?", "Optimierung", [System.Windows.Forms.MessageBoxButtons]::YesNo) -eq 'Yes') {
            $optCmd = 'esxcli system settings advanced set -o /Disk/MaxQueryRetries -i 100; ADAPTER=$(esxcli iscsi adapter list | awk "NR==3 {print \$1}"); esxcli iscsi adapter param set -A $ADAPTER -k LoginTimeout -v 30; esxcli system settings advanced list -o /Disk/MaxQueryRetries | grep "Int Value"; esxcli iscsi adapter param get -A $ADAPTER | grep LoginTimeout'
            Invoke-DualConsoleCommand -session $Global:sourceConsoleSession -command $optCmd -outputBox $diagOutput
            $diagOutput.AppendText("`n-> Optimierung abgeschlossen.`n")
        }
    })
    ...
    $diagPopup.Controls.AddRange(@($diagLabel, $btnLockCheck, $btnVaaiCheck, $btnStorageOpt, $btnHpCheck, $diagOutput))
...
# VERSION: V8.6.6 (Fix: Log-Filename for Live-View & Stable Logic)
# =======================================================================
...
log_raw "  - Typ: Manueller Multi-VM Hot-Klon V8.6.6"
...
log_raw "Startzeit: $(date '+%Y-%m-%d %H:%M:%S')"
log_raw "Job-Konfiguration:"
log_raw "  - Typ: Manuell Single-VM Hot-Klon V8.6.6"
...
for SOURCE_VM_NAME in ${VM_LIST}; do
    ...
    log "#########8.6.6########### Starte Klon für VM: ${SOURCE_VM_NAME} ####################"
    log "initiate backup for ${SOURCE_VM_NAME}"
...
log_raw "Startzeit: $(date '+%Y-%m-%d %H:%M:%S')"
log_raw "Job-Konfiguration:"; log_raw "  - Typ: Geplante GhettoVCB Wiederherstellung V8.6.6"; log_raw "  - Quelle: ${SOURCE_PATH}"; log_raw "  - Ziel-Datastore: ${TARGET_DATASTORE}"; log_raw "  - Neuer VM-Name: ${NEW_VM_NAME}";
log_raw "--- START DES DETAILLOGS ---"
...
#!/bin/sh
# GhettoGUI Scheduled Multi-VM Clone Helper V8.5.9 (Fix: SCSI-ID Based Naming)
PATH=/bin:/sbin:/usr/bin:/usr/sbin:/usr/lib/vmware/bin
export PATH
...
log_raw "Startzeit: $(date '+%Y-%m-%d %H:%M:%S')"
log_raw "Job-Konfiguration:"
log_raw "  - Typ: Manueller Restore V8.5.9"
...
log_raw "Job-Konfiguration:"
log_raw "  - Typ: Geplante Replikation (H2H V8.6.6)"
...
log_raw "Job-Konfiguration:"
log_raw "  - Typ: Manuelle Replikation (H2H) V8.6.6"
log_raw "  - Methode: ${REPLICATION_METHOD}"
