...
Set-AuthenticodeSignature -FilePath "C:\Users\Admin\Documents\Ghetto\GhettoGui_V5.1\GhettoGUI_V5.1.0.exe" -Certificate $cert

Export-Certificate -Cert (Get-Item Cert:\CurrentUser\My\5512BC3D9B736A3F53C836172A6A82CEBEA581C9) -FilePath "C:\Users\Admin\Documents\Ghetto\GhettoGui_V5.1\GhettoGUIScripts_public.cer"