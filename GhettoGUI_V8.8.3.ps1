# GhettoGUI_8.8.3.ps1
#
# --- VERSION 8.8.3 (Final Stable Release by Gemini & Chrigel#71)
...
# - NEU: Proxmox 9.0
# - ghettoVCB_patch_V9.5.sh & sendmail_V9.5.py 21.02.2026
...
$form.Text = "GhettoGUI ESXi & GhettoVCB Manager 8.8.3 / 21.02.2026"
...
# VERSION: 8.8.3 (Fix: Log-Filename for Live-View & Stable Logic)
# =======================================================================
...
#!/bin/sh
# GhettoGUI Multi-VM Clone Helper 8.8.3 (Final Log & Email Fix)
...
log_raw "  - Typ: Manueller Multi-VM Hot-Klon 8.8.3"
...
# =======================================================================
# DATEI: CloneScript_Templates_V8.5.0.ps1
# VERSION: 8.8.3 (Final Parity - Based on V54.24 Replication Logic)
# =======================================================================
...
$cloneScriptTemplate = @'
#!/bin/sh
# GhettoGUI Single-VM Clone Helper 8.8.3 (Manual - Stable Email & SCSI-ID)
...
log_raw "Startzeit: $(date '+%Y-%m-%d %H:%M:%S')"
log_raw "Job-Konfiguration:"
log_raw "  - Typ: Manuell Single-VM Hot-Klon 8.8.3"
...
log_raw "Startzeit: $(date '+%Y-%m-%d %H:%M:%S')"
log_raw "Job-Konfiguration:"; log_raw "  - Typ: Geplante GhettoVCB Wiederherstellung 8.8.3"; log_raw "  - Quelle: ${SOURCE_PATH}"; log_raw "  - Ziel-Datastore: ${TARGET_DATASTORE}"; log_raw "  - Neuer VM-Name: ${NEW_VM_NAME}";
log_raw "--- START DES DETAILLOGS ---"
...
#!/bin/sh
# GhettoGUI Scheduled Multi-VM Clone Helper 8.8.3 (Fix: SCSI-ID Based Naming)
PATH=/bin:/sbin:/usr/bin:/usr/sbin:/usr/lib/vmware/bin
export PATH
...
log_raw "Startzeit: $(date '+%Y-%m-%d %H:%M:%S')"
log_raw "Job-Konfiguration:"
log_raw "  - Typ: Manueller Restore 8.8.3"
...
log_raw "Job-Konfiguration:"
log_raw "  - Typ: Geplante Replikation (H2H 8.8.2)"
...
log_raw "Job-Konfiguration:"
log_raw "  - Typ: Manuelle Replikation (H2H) 8.8.3"
log_raw "  - Methode: ${REPLICATION_METHOD}"
